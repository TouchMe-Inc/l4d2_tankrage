...
public void OnPluginStart()
{
    ...
    g_cvFreezeTime = CreateConVar("sm_tankrage_freezetime", "4.0", "");
...
void Event_TankSpawn(Event hEvent, char[] szEventName, bool dontBroadcast)
{
...
void Event_ResetTank(Event hEvent, char[] szEventName, bool dontBroadcast)
{
